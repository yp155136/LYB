...
\fancyhead[L]{National Taiwan University BBCube}
\fancyhead[R]{\thepage}
...
\lstinputlisting{geometry/minimum_enclosing_cycle.cpp}
...
\lstinputlisting{adhoc/bigint.cpp}

\subsection{SMAWK}
\lstinputlisting{adhoc/smawk.cpp}

\subsection{Fractions, Decimal}
\lstinputlisting{adhoc/fraction_and_decimal.py}

\subsection{dinic part}
\lstinputlisting{adhoc/dinic.cpp}
